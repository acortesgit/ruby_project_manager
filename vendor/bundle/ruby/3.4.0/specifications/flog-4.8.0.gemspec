...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<sexp_processor>.freeze, ["~> 4.8".freeze])
  s.add_runtime_dependency(%q<ruby_parser>.freeze, ["~> 3.1".freeze, "> 3.1.0".freeze])
  s.add_runtime_dependency(%q<path_expander>.freeze, ["~> 1.0".freeze])
