...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<addressable>.freeze, ["= 2.8.6".freeze])
  s.add_development_dependency(%q<capybara>.freeze, ["~> 3.39.2".freeze])
  s.add_development_dependency(%q<e2mmap>.freeze, ["~> 0.1.0".freeze])
  s.add_development_dependency(%q<fakefs>.freeze, ["~> 2.5.0".freeze])
  s.add_development_dependency(%q<matrix>.freeze, ["~> 0.4.2".freeze])
  s.add_development_dependency(%q<mime-types>.freeze, ["= 3.5.2".freeze])
  ...
  s.add_development_dependency(%q<rack-test>.freeze, ["> 0.7".freeze, "~> 2.1.0".freeze])
end
